...
//  Eddie 1.3
//
//  Created by Lucie Hrbkova on 22/03/2022.
//
...
class PDFCreator: NSObject {
    ...
    init(title: String, body: String, image: UIImage, image2: UIImage, contact: String) {
      self.title = title
      self.body = body
      self.image = image
      self.image2 = image2
    ...
    func createFlyer() -> Data {
      // 1
      let pdfMetaData = [
        kCGPDFContextCreator: "Eddie app Report",
        kCGPDFContextAuthor: "Lucie Hrbkova",
      ...
      let data = renderer.pdfData { (context) in
        ...
        // 6
          ...
          let imageSecond = addImage2(pageRect: pageRect, imageTop: imageBottom + 18.0)
...
//    }
    ...
    func addImage(pageRect: CGRect, imageTop: CGFloat) -> CGFloat {
      // 1
      let maxHeight = pageRect.height * 0.08
      let maxWidth = pageRect.width * 0.16
      // 2
